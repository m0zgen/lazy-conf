...
dnf -y install git mc htop nano wget rdesktop arandr tigervnc xclip hunspell-ru ccze youtube-dl ffmpeg nmap alacarte evolution geany gimp freemind vlc kruler plank roxterm wine nscd tuned
